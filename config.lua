...
lvim.keys.normal_mode["<C-A-Down>"] = ":resize -2<CR>"
lvim.keys.normal_mode["<C-A-Up>"] = ":resize +2<CR>"
lvim.keys.normal_mode["<C-A-Left>"] = ":vertical resize -2<CR>"
lvim.keys.normal_mode["<C-A-Right>"] = ":vertical resize +2<CR>"
